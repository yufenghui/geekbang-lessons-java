...
```json
{
  ...
  "propertySources": [
    {
      "name": "fileSystemPropertySource",
      "source": {
        "my.city": "xian"
      }
    },
    {
      "name": "file://D:\\study\\geekbang-lessons-java/my-spring-cloud-config-server/src/main/resources/config-repo/my-config-client.properties",
      "source": {
        "my.name": "yfh",
        "my.age": "32"
      }
